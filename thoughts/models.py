...
class Category(models.Model):
    ...
    slug = models.SlugField(max_length=255, help_text='Slug of the category for SEO purposes')
...
class Thought(models.Model):
    ...
    categories = models.ManyToManyField(Category, help_text='Categories of the thought')


    title = models.CharField(max_length=255, help_text='Title of the thought')
    text = RichTextField()
